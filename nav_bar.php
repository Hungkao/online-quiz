			...
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right"><h3 style="color:white">Simple Online Quiz System</h3></p>
				</div>
				<div class = "nav navbar-nav navbar-right">
					<a href="logout.php" style="color:white"><?php echo $name ?> <i class="fa fa-power-off"></i></a>
				</div>
			</div>
		</nav>
		<style>
