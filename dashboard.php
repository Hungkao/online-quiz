        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li <?php echo''; ?> > <a href="logout1.php?q=dashboard.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true" style="color:white"></span>&nbsp;Log out</a></li>
                </ul>
            </div>
        </div>
    </nav>
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12"> 
                                        <input  type="submit" style="margin-left:45%" class="btn btn-danger" value="Submit" class="btn btn-danger"/>
                                    </div>
                                </div>
