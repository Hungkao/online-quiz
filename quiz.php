...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 p-0 font-weight-bold mb-3">Quiz List</div>
		<button class="btn btn-danger bt-sm" id="new_quiz"><i class="fa fa-plus"></i>	Add New</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
							 <a class="btn btn-sm btn-outline-warning edit_quiz" href="./quiz_view.php?id=<?php echo $row['id']?>"><i class="fa fa-task"></i> Manage</a>
							 <button class="btn btn-sm btn-outline-warning edit_quiz" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Edit</button>
					...
					<div class="modal-content">
						...
						<form id='quiz-frm'>
							...
							<div class="modal-footer">
								<button  class="btn btn-danger" name="save"><span class="glyphicon glyphicon-save"></span> Save</button>
							</div>
						</form>
					</div>
				</div>
