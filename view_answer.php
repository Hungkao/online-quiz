...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 p-0 font-weight-bold mb-3"><?php echo $quiz['title'] ?> | <?php echo $quiz['qpoints'] .' Points Each Question' ?></div>
		<div class="col-md-12 alert alert-success">Điểm : <?php echo $hist['score'] .' / ' .  $hist['total_score'] ?></div>
		<br>
		<div class="card">
			<div class="card-body">
