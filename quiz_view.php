...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 p-0 font-weight-bold mb-3"><?php echo $qry['title'] ?></div>
		<button class="btn btn-danger bt-sm" id="new_question"><i class="fa fa-plus"></i>	Add Question</button>
		<button class="btn btn-danger bt-sm" id="new_student"><i class="fa fa-plus"></i>	Add Student</button>
		<br>
		<br>
